export default
    `void explosionUpdatePacked(Explosion *explosion, EntityBuffer *entityBuffer, int numEntities)
{
	...
	__m128 *entitiesX = (__m128 *)entityBuffer->x;
	__m128 *entitiesY = (__m128 *)entityBuffer->y;
	__m128 *entitiesHealth = (__m128 *)entityBuffer->health;
